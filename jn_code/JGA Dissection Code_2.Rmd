...
f1 <- ggplot(df_tidy_filtered, aes(x = class.JGA, y = Gene, fill = Expression)) +
  geom_tile() +
...
markers.to.plot2c <- c("F2r", "Ccn1", "Itga8", "Itgab1", "Bmp7", "Bmp3", "Acvr1", "Acvr2b", "Sfrp1")
