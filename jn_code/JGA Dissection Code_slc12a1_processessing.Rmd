...
colorblind_friendly_population_colors <- c(
  ...
  "MD" = "#666600" # dark yellow-green
  )

colorblind_friendly_population_colors <- c(
  "Pericyte" = "#92C5DE",        # Lighter Blue
  "Efferent VSMC" = "#F4A582",   # Lighter Orange
  "Afferent VSMC" = "#A6D9A5",   # Lighter Green
  "Renin Cell" = "#F7F79A",      # Lighter Yellow
  "EG Mesangial Cell" = "#92B2E2", # Lighter Deep Blue
  "IG Mesangial Cell" = "#F4A6A1", # Lighter Reddish-Orange
  "TAL A" = "#E4B6D2",        # Lighter Purple
  "TAL B" = "#B07C8C",       # Lighter Dark Red
  "MD" = "#B3B35C" # Lighter Dark Yellow-Green
)

colorblind_friendly_population_colors2 <- c(
  "Pericyte" = "#CFE2F3",        # Very Light Blue
  "Efferent VSMC" = "#FAD8B4",   # Very Light Orange
  "Afferent VSMC" = "#D8F2D2",   # Very Light Green
  "Renin Cell" = "#FCFBC2",      # Very Light Yellow
  "EG Mesangial Cell" = "#C4D7F2", # Very Light Deep Blue
  "IG Mesangial Cell" = "#F7CAC9", # Very Light Reddish-Orange
  "TAL A" = "#F3DAE8",        # Very Light Purple
  "TAL B" = "#D6A5AE",       # Lighter Dark Red
  "MD" = "#D6D6A3" # Very Light Dark Yellow-Green
)


colorblind_friendly_population_colors_dark <- c(
  "Pericyte" = "#1F78B4",        # Darker Blue
  "Efferent VSMC" = "#B15928",   # Darker Orange-Brown
  "Afferent VSMC" = "#006D5B",   # Darker Green
  "Renin Cell" = "#B8A600",      # Darker Yellow
  "EG Mesangial Cell" = "#004C91", # Darker Deep Blue
  "IG Mesangial Cell" = "#9C3E00", # Darker Reddish-Orange
  "TAL A" = "#884C74",        # Darker Purple
  "TAL B" = "#5F1F3B",       # Darker Dark Red
  "MD" = "#4A4A00" # Darker dark yellow-green
)
...
colorblind_friendly_population_colors <- c(
  ...
  "Afferent VSMC" = "#009E73",   # Green
  "Renin Cell" = "#F0E442",      # Yellow
  "EG Mesangial Cell" = "#882255", # Dark Red (replacing deep blue)
  "IG Mesangial Cell" = "#D55E00", # Reddish-Orange
  "TAL A" = "#CC79A7",        # Purple (distinct from others)
  "TAL B" = "#332288",       # Dark Blue-Purple (instead of another red)
  "MD" = "#999933" # Olive Green (instead of dark yellow-green)
)
...
markers.to.plot1 <- c("Gja1", "Gja3", "Gja4", "Gja5", "Gja6", "Gja7", "Gja8", "Gja9", "Gja10", "Gja11", "Gja12", "Gjc1", "Gjc2", "Gjc3", "Gjd1", "Gjd2", "Gjd3", "Gjd4")
